      ...
      <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-6xl">
        ...
        <form @submit.prevent="addProduct" class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="md:col-span-3 flex justify-center">
            <button type="submit"
              class="bg-primary2 hover:bg-primary text-white font-bold py-3 px-6 rounded-full focus:outline-none focus:ring-4 focus:ring-blue-300 transition duration-300 ease-in-out">Add
              Product</button>
          </div>
        </form>
      </div>
