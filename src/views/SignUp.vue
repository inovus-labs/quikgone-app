<template>
    <div class="flex flex-col md:flex-row h-screen">
        ...
        <div class="flex-1 md:w-1/3 bg-primary2 flex items-center justify-center pt-8 px-4 py-8 md:px-0 overflow-y-auto"> <!-- Adjusted width here and added overflow-y-auto -->
            <div class="w-full max-w-md  mt-12 bg-bgSecondary   pb-2"> <!-- Added top and bottom padding -->
                <!-- Form Content -->
